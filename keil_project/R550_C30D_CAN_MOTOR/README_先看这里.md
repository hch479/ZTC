...
打开后，Keil 左侧工程树应出现 `CHASSIS_CAN` 分组，其中有 6 个已经加入编译的 C 文件。
...
2. `C/C++ -> Include Paths` 中应有 `..\CHASSIS_CAN\inc`。
3. `Linker` 应使用 `..\CHASSIS_CAN\WHEELTEC_reserve_sector7.sct`。
